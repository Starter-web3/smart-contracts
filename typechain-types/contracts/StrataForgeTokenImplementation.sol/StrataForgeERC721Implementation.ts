...
export interface StrataForgeERC721ImplementationInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "safeMintWithURI",
    values: [AddressLike, string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "safeTransfersFrom",
    values: [AddressLike, AddressLike, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface StrataForgeERC721Implementation extends BaseContract {
  connect(runner?: ContractRunner | null): StrataForgeERC721Implementation;
  waitForDeployment(): Promise<this>;

  interface: StrataForgeERC721ImplementationInterface;
  ...
  safeMintWithURI: TypedContractMethod<
    [to: AddressLike, uri: string],
    [bigint],
    "nonpayable"
  >;
  ...
  safeTransfersFrom: TypedContractMethod<
    [from: AddressLike, to: AddressLike, tokenId: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "safeMintWithURI"
  ): TypedContractMethod<
    [to: AddressLike, uri: string],
    [bigint],
    "nonpayable"
  ...
  >;
  getFunction(
    nameOrSignature: "safeTransfersFrom"
  ): TypedContractMethod<
    [from: AddressLike, to: AddressLike, tokenId: BigNumberish],
    [void],
    "nonpayable"
