...
export interface StrataForgeERC1155ImplementationInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface StrataForgeERC1155Implementation extends BaseContract {
  connect(runner?: ContractRunner | null): StrataForgeERC1155Implementation;
  waitForDeployment(): Promise<this>;

  interface: StrataForgeERC1155ImplementationInterface;
  ...
  burnBatch: TypedContractMethod<
    [account: AddressLike, ids: BigNumberish[], amounts: BigNumberish[]],
    [void],
    "nonpayable"
  >;
  ...
  initialize: TypedContractMethod<
    [uri_: string, tokenOwner: AddressLike, features: boolean[]],
    [void],
    "nonpayable"
  >;
